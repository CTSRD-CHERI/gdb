...
const struct aarch64_operand aarch64_operands[] =
{
  ...
  {AARCH64_OPND_CLASS_ADDRESS, "ADDR_ADRP", OPD_F_SEXT | OPD_F_HAS_INSERTER | OPD_F_HAS_EXTRACTOR, {FLD_immhi, FLD_immlo}, "21-bit PC-relative address of a 4KB page"},
  ...
  {AARCH64_OPND_CLASS_CAP_REG, "Cad", OPD_F_HAS_INSERTER | OPD_F_HAS_EXTRACTOR, {FLD_Cad}, "a Capability register"},
  {AARCH64_OPND_CLASS_CAP_REG, "Cam", OPD_F_HAS_INSERTER | OPD_F_HAS_EXTRACTOR, {FLD_Cam}, "a Capability register"},
  {AARCH64_OPND_CLASS_CAP_REG, "Can", OPD_F_HAS_INSERTER | OPD_F_HAS_EXTRACTOR, {FLD_Can}, "a Capability register"},
  {AARCH64_OPND_CLASS_CAP_REG, "Cas", OPD_F_HAS_INSERTER | OPD_F_HAS_EXTRACTOR, {FLD_Cas}, "a Capability register used as a source"},
  {AARCH64_OPND_CLASS_CAP_REG, "Cat", OPD_F_HAS_INSERTER | OPD_F_HAS_EXTRACTOR, {FLD_Cat}, "a Capability register"},
  {AARCH64_OPND_CLASS_CAP_REG, "Cat2", OPD_F_HAS_INSERTER | OPD_F_HAS_EXTRACTOR, {FLD_Cat2}, "a Capability register"},
  {AARCH64_OPND_CLASS_CAP_REG, "Cad_SP", OPD_F_MAYBE_CSP | OPD_F_HAS_INSERTER | OPD_F_HAS_EXTRACTOR, {FLD_Cad}, "a Capability register or a capability stack pointer register"},
  ...
  {AARCH64_OPND_CLASS_IMMEDIATE, "A64C_AIMM", OPD_F_HAS_INSERTER | OPD_F_HAS_EXTRACTOR, {FLD_a64c_shift_ai,FLD_imm12}, "a 12-bit unsigned immediate with optional left shift of 12 bits"},
  {AARCH64_OPND_CLASS_IMMEDIATE, "A64C_IMM8", OPD_F_HAS_INSERTER | OPD_F_HAS_EXTRACTOR, {FLD_a64c_imm8}, "8-bit unsigned immediate"},
  {AARCH64_OPND_CLASS_IMMEDIATE, "A64C_IMM6_EXT", OPD_F_HAS_INSERTER | OPD_F_HAS_EXTRACTOR, {FLD_a64c_shift, FLD_imm6_15}, "6-bit unsigned immediate"},
  {AARCH64_OPND_CLASS_PERM, "PERM", OPD_F_HAS_INSERTER | OPD_F_HAS_EXTRACTOR, {}, "a capability permission"},
  {AARCH64_OPND_CLASS_FORM, "FORM", OPD_F_HAS_INSERTER | OPD_F_HAS_EXTRACTOR, {}, "a capability form"},
  {AARCH64_OPND_CLASS_ADDRESS, "CAPADDR_SIMM7", OPD_F_SHIFT_BY_4 | OPD_F_HAS_INSERTER | OPD_F_HAS_EXTRACTOR, {FLD_capaddr_simm7}, "a capability based address with 7-bit signed immediate offset"},
  {AARCH64_OPND_CLASS_ADDRESS, "CAPADDR_SIMPLE", OPD_F_HAS_INSERTER | OPD_F_HAS_EXTRACTOR, {}, "a capability address with base register (no offset)"},
  {AARCH64_OPND_CLASS_ADDRESS, "A64C_ADDR_SIMM7", OPD_F_HAS_INSERTER | OPD_F_HAS_EXTRACTOR, {FLD_imm7,FLD_a64c_index2}, "an address with 7-bit signed immediate offset"},
  {AARCH64_OPND_CLASS_ADDRESS, "A64C_ADDR_SIMM9", OPD_F_SHIFT_BY_4 | OPD_F_HAS_INSERTER | OPD_F_HAS_EXTRACTOR, {FLD_imm9,FLD_index}, "an address with 7-bit signed immediate offset"},
  ...
  {AARCH64_OPND_CLASS_IMMEDIATE, "A64C_ADDR_ADRDP", OPD_F_HAS_INSERTER | OPD_F_HAS_EXTRACTOR, {FLD_a64c_immhi, FLD_immlo}, "20-bit data-relative offset"},
  {AARCH64_OPND_CLASS_CAP_REG, "Cat_SYS", OPD_F_HAS_INSERTER | OPD_F_HAS_EXTRACTOR, {FLD_Rt}, "an integer register"},
